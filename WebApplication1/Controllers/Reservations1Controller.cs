...
namespace WebApplication1.Controllers
{
    public class Reservations1Controller : Controller
    {
        ...
        {
            var reservations = db.Reservations.Include(r => r.Rooms);
        ...
        public ActionResult Create([Bind(Include = "id,ResevationID,RoomID,CheckInDate,CheckedOutDate")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,ResevationID,RoomID,CheckInDate,CheckedOutDate")] Reservation reservation)
        {
            if (ModelState.IsValid)
            {
