...
namespace WebApplication1.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public ActionResult Index(string searchBy, string search)
        {
            ...
            if (searchBy == "Name")
            {
                var city = db.Cities.Include(s => s.Province).Where((x => x.CityName.Contains(search) || search == null));
                return View(city.ToList());
            }
            else
            {

                var city = db.Cities.Include(s => s.Province).Where((x => x.Province.ProvinceName.Contains(search) || search == null));
                return View(city.ToList());
