...
namespace WebApplication1.Controllers
{
    public class CheckOutsController : Controller
    {
        ...
        {
            var checkOuts = db.CheckOuts.Include(c => c.RoomReservations);
        ...
        public ActionResult Create([Bind(Include = "CheckInID,CheckOutDate,ReservationID")] CheckOut checkOut)
        {
            if (ModelState.IsValid)
            {
                RoomReservation roomReservation = new RoomReservation();
                roomReservation = db.RoomReservations.Find(checkOut.ReservationID);
                roomReservation.ACheckOut = checkOut.CheckOutDate;
                roomReservation.BookingStatus = "Available";
